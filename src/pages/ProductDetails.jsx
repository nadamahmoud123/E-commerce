...
const ProductDetails = () => {
  ...
  const { authenticated } = useAuth(); // Use the authentication context
              ...
              {tab === "desc" ? (
                ...
                <div className="tab__form mb-3">
                  <div className="review pt-5">
                    <p className="user__name mb-0">mary</p>
                    <p className="user__email">mary@gmail.com</p>
                    <p className="feedback__text">good product</p>
                  </div>
